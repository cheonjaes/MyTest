	...
	// DEFAULT : JAVA = BIG_ENDIAN
		...
		*/
		...
		public static String  Encrpyt(String str)
		{
		    ...
		    //str = "6584263hfoshfosjfosjfoasfhai한글";
		    SHA256_Encrpyt(str.getBytes(), str.getBytes().length, pbCipher);
		    for (int i=0; i<32; i++){	
		    	//System.out.print(Integer.toHexString(0xff&pbCipher[i])+" ");
		    	sb.append(Integer.toString((pbCipher[i]&0xff) + 0x100, 16).substring(1));
		    }
		    //System.out.print("\n\n");
		    
		    //System.out.print(new String(pbCipher));
		    //System.out.print(sb.toString());
		    //return new String(pbCipher);
		    return sb.toString();
		}
}
